...
pub struct InteractInfo {
    ...
    #[prost(enumeration = "InteractTarget", repeated, tag = "9")]
...
pub struct HollowGridComponent {
    #[prost(enumeration = "GridType", tag = "1")]
    pub grid_type: i32,
    #[prost(enumeration = "GridLink", tag = "2")]
    pub grid_link: i32,
    #[prost(enumeration = "GridUnkEnum", tag = "3")]
...
pub struct HollowGridMapsInfo {
    ...
    #[prost(enumeration = "HollowGridMapType", tag = "3")]
...
pub struct InteractWithUnitCsReq {
    ...
    #[prost(int32, tag = "2")]
    pub interact_id: i32,
    #[prost(enumeration = "InteractTarget", tag = "3")]
    pub r#type: i32,
}
#[derive(::proto_derive::NetCmd)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct SectionEventScNotify {
    ...
    pub section_event_map_str_str_2: ::std::collections::HashMap<
        ...
        ::prost::alloc::string::String,
    >,
    #[prost(enumeration = "EventGraphOwnerType", tag = "12")]
    pub owner_type: i32,
    ...
    /// ! Some unknown field was deprecated
    #[prost(string, tag = "16")]
...
pub struct HollowPushScNotify {
    ...
    pub entity_type: i32,
    #[prost(enumeration = "HollowPushReason", tag = "5")]
    pub reason: i32,
}
#[derive(::proto_derive::NetCmd)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct AddAvatarScNotify {
    #[prost(uint32, tag = "1")]
    pub avatar_id: u32,
    #[prost(enumeration = "add_avatar_sc_notify::PerformType", tag = "2")]
