...
```sh
git clone -b 2.2_beta https://git.xeondev.com/yixuan-rs/yixuan-rs.git
cd yixuan-rs
...
### Logging in
Currently supported client version is `CNBetaWin2.2.1`, you can get it from 3rd party sources (e.g. game launcher). Next, you have to apply the necessary [client patch](https://git.xeondev.com/yuzuha-rs/yuzuha-patch/releases/tag/CNBetaWin2.2.1). It allows you to connect to the local server and replaces encryption keys with custom ones.
